...
// Geração determinística (sem aleatoriedade) para demo estável.
// Colunas: data, produto, categoria, cliente, quantidade, preço unitário,
//          receita, custo, lucro, vendedor, região, status do pedido.
import type { Workbook, SheetData } from './types'

const PRODUTOS: [string, string, number, number][] = [
  // [produto, categoria, preço, custo]
...
function buildDemoSheet(): SheetData {
  ...
  // 60 registros distribuídos em Jan–Mai/2025
